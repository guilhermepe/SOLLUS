sap.ui.define([
		...
		"use strict";
		return BaseController.extend("com.guiper.sollus.controller.measure.Measure", {
			...
			onInit: function () {
				...
				try {
					sap.ui.require([
						...
						this.byId("statisticsContainer").addContent(sap.ui.xmlview({id: this.getView().createId("charts"), viewName : "com.guiper.sollus.view.StatisticsMicro"}));
					}.bind(this));
				} catch (oException) {
					// no microcharts available: use d3 view
					this.byId("statisticsContainer").addContent(sap.ui.xmlview({id: this.getView().createId("charts"), viewName : "com.guiper.sollus.view.StatisticsD3"}));
				}
			},
