 ...
 */
@Entity
@Table(name = "historicorecente_ea")
public class HistoricoRecenteEa implements Serializable{
   ...
   private Date dataHora;
    ...
    public HistoricoRecenteEa() {
    }

    public HistoricoRecenteEa(long id, long idPorta, int alarme, float valorPorta, Date dataHora) {
        this.id = id;
    ...
    public String toString() {
        return "HistoricoRecenteEa[" + "id=" + id + ", idPorta=" + idPorta + ", alarme=" + alarme + ", valorPorta=" + valorPorta + ", dataHora=" + dataHora + ']';
    }
