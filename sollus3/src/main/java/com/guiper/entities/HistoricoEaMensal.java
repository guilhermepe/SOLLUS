 ...
 */
@Entity
@Table(name = "historico_ea_mensal")
public class HistoricoEaMensal implements Serializable{
   ...
   private Date diaRegistro;
    ...
    public HistoricoEaMensal() {
    }

    public HistoricoEaMensal(long id, long idPorta, String nomePorta, long idEquipamento, String nomeEquipamento, long idConta, String nomeConta, float valorPortaInicial, float valorPortaFinal, float valorPortaDelta, Date diaRegistro) {
        this.id = id;
    ...
    public String toString() {
        return "HistoricoEaMensal[" + "id=" + id + ", idPorta=" + idPorta + ", nomePorta=" + nomePorta + ", idEquipamento=" + idEquipamento + ", nomeEquipamento=" + nomeEquipamento + ", idConta=" + idConta + ", nomeConta=" + nomeConta + ", valorPortaInicial=" + valorPortaInicial + ", valorPortaFinal=" + valorPortaFinal + ", valorPortaDelta=" + valorPortaDelta + ", diaRegistro=" + diaRegistro + ']';
    }
