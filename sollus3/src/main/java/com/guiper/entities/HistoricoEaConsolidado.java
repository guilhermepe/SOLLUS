 ...
 */
@Entity
@Table(name = "historico_ea_consolidado")
public class HistoricoEaConsolidado implements Serializable{
   ...
   private Date dataHora;
    ...
    public HistoricoEaConsolidado() {
    }

    public HistoricoEaConsolidado(long id, long idPorta, int alarme, float valorPorta, Date dataHora) {
        this.id = id;
    ...
    public String toString() {
        return "HistoricoEaConsolidado[" + "id=" + id + ", idPorta=" + idPorta + ", alarme=" + alarme + ", valorPorta=" + valorPorta + ", dataHora=" + dataHora + ']';
    }
