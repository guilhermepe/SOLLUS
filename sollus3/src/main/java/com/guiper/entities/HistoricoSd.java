 ...
 */
@Entity
@Table(name = "historico_sd")
public class HistoricoSd implements Serializable{
   ...
   private Date dataHora;
    ...
    public HistoricoSd(long id, long idPorta, int alarme, float valorPorta, Date dataHora) {
        this.id = id;
    ...
    public String toString() {
        return "HistoricoSd[" + "id=" + id + ", idPorta=" + idPorta + ", alarme=" + alarme + ", valorPorta=" + valorPorta + ", dataHora=" + dataHora + ']';
    }
